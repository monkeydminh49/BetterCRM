...
//        listMenu1.addItem(new Model_Menu("", "", Model_Menu.MenuType.EMPTY));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/logo-llv.png"))); // NOI18N
        jLabel1.setText("BetterCRM");
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, new Color(33, 102, 1), 0, getHeight(), new Color(33, 102, 1));
        g2.setPaint(g);
