...
public class DateChooser extends JComponent {
    ...
    public void setLabelCalendar(JLabel labelCalendar) {
        this.labelCalendar = labelCalendar;
//        labelCalender.setEditable(false);
        labelCalendar.addMouseListener(
                new MouseAdapter() {
                    @Override
                    public void mouseReleased(MouseEvent mouseEvent) {
                        if (labelCalendar.isEnabled()) {
    ...
    public void showPopup() {
        ...
        popup.show(labelCalendar, 0, labelCalendar.getHeight());
    }
    ...
    private void createHeader() {
        ...
        JButton cmdBack = new JButton(new FlatSVGIcon(getClass().getResource("/arrowCollapse.svg")));
        JButton cmdNext = new JButton(new FlatSVGIcon(getClass().getResource("/arrowExpand.svg")));
    ...
    private void displayDate() {
        if (labelCalendar != null) {
            if (dateSelectionMode == DateSelectionMode.SINGLE_DATE_SELECTED) {
                if (isDateSelected()) {
                    labelCalendar.setText(dateChooserRender.renderTextFieldDate(this, getSelectedDate()));
                } else {
                ...
                if (selectedCount != 0) {
                    labelCalendar.setText(dateChooserRender.renderTextFieldDateBetween(this, dateBetween));
                } else {
                    labelCalendar.setText("");
                }
            }
